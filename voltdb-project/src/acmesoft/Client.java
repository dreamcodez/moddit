...
import acmesoft.procedures.*;

public class Client {

    /** Example SELECT: select rows matching the specified id parameter.
     *
     * Call <code>acmesoft.procedures.Select</code> passing
    ...
    private void doSelect(int id) {
        ...
        try {
            ...
            for (int ii = 0; ii < rowCount; ii++) {
                ...
                final long neptune2_ID = row.getLong(0);
                final long neptune2_ITEM = row.getLong(1);
                System.out.println("Selected: neptune2_ID == " + neptune2_ID + " neptune2_ITEM == " + neptune2_ITEM);
            }
     ...
     * and item parameters.
     *
     * Call <code>acmesoft.procedures.Insert</code> passing
     ...
     *
     * Call <code>acmesoft.procedures.Insert</code> with an
     ...
     *
     *  Call <code>acmesoft.procedures.Delete</code> passing
